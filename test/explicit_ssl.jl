...
# ###############################################################################
 ...
 options = RequestOptions(ssl=true, implicit=false, active_mode=false, verify_peer=false, username=user, passwd=pswd, hostname=host)
...
options = RequestOptions(ssl=true, implicit=false, active_mode=true, verify_peer=false, username=user, passwd=pswd, hostname=host)
