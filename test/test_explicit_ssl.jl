...
options = RequestOptions(isSSL=true, isImplicit=false, active_mode=false, verify_peer=false, username=user, passwd=pswd)
...
options = RequestOptions(isSSL=true, isImplicit=false, active_mode=true, verify_peer=false, username=user, passwd=pswd)
